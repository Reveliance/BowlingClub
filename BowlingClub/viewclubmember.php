...
<html>
	...
	<body class="subpage">
		...
		<!-- Nav -->
			<nav id="menu">
				<ul class="links">
					<li> <a href="adminloginmenu.php">Admin Menu Page</a></li>				
					<li> <a href="deleteclubmember.php">Delete Club Member</a></li>
...
{
	echo "<tr valign=top width=50%><td>";echo $x;
	echo "<td>";
	echo $row[0];echo"</td><td>";
	echo $row[1];echo"</td><td>";
	echo $row[2];echo"</td><td>";
	echo $row[3];echo"</td><td>";
	echo $row[4];echo"</td><td>";
	echo $row[5];echo"</td><td>";
	echo $row[6];echo"</td></tr>";
	$x++;
}
?>
